    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          <span>
            We redefine advertising by providing a unique canvas for your brand.
            Each of our 10,000 individual blocks is an exclusive opportunity for
            you to showcase your message to the world.
          </span>
          <span>
